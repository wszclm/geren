...
}
{
    ...
    let taiyuan=document.querySelector('.taiyuan');
    let zuobiao=document.querySelector('.zuobiao')
    ss.onfocus=function () {
        if (this.value=="流量"){
            this.value=""
        }
    ...
    zuobiao.onclick=function () {
        taiyuan.style.display="block";
    }
}
{
    let item=document.querySelectorAll('.nF5z li');
    let main=document.querySelectorAll('.fff');
